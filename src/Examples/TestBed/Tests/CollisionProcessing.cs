...
namespace TestBed
{
	...
	public class CollisionProcessing : Test
	{
		...
		public CollisionProcessing()
		{
			...
			triangleBodyDef.Position.Set(Box2DNet.Common.MathB2.Random(xLo, xHi), 35f);
			...
			//triangleBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), Box2DNet.Common.Math.Random(yLo, yHi));
			triangleBodyDef.Position.Set(Box2DNet.Common.MathB2.Random(xLo, xHi), 30f);
			...
			boxBodyDef.Position.Set(Box2DNet.Common.MathB2.Random(xLo, xHi), 25f);
			...
			//boxBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), Box2DNet.Common.Math.Random(yLo, yHi));
			boxBodyDef.Position.Set(Box2DNet.Common.MathB2.Random(xLo, xHi), 15f);
			...
			circleBodyDef.Position.Set(Box2DNet.Common.MathB2.Random(xLo, xHi), 10f);
			...
			//circleBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), Box2DNet.Common.Math.Random(yLo, yHi));
			circleBodyDef.Position.Set(Box2DNet.Common.MathB2.Random(xLo, xHi), 5f);
