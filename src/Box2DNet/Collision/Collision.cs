...
namespace Box2DNet.Collision
{
	...
	{
		public static readonly byte NullFeature = Common.MathB2.UCHAR_MAX;
	...
	public struct AABB
	{
		...
		{
			LowerBound = Common.MathB2.Min(aabb1.LowerBound, aabb2.LowerBound);
			UpperBound = Common.MathB2.Max(aabb1.UpperBound, aabb2.UpperBound);
		}
		...
		public void Initialize(Manifold manifold, XForm xfA, float radiusA, XForm xfB, float radiusB)
		{
			...
			switch (manifold.Type)
			{
				case ManifoldType.Circles:
					{
						Vec2 pointA = Common.MathB2.Mul(xfA, manifold.LocalPoint);
						Vec2 pointB = Common.MathB2.Mul(xfB, manifold.Points[0].LocalPoint);
				...
				case ManifoldType.FaceA:
					{
						Vec2 normal = Common.MathB2.Mul(xfA.R, manifold.LocalPlaneNormal);
						Vec2 planePoint = Common.MathB2.Mul(xfA, manifold.LocalPoint);
						...
						{
							Vec2 clipPoint = Common.MathB2.Mul(xfB, manifold.Points[i].LocalPoint);
				...
				case ManifoldType.FaceB:
					{
						Vec2 normal = Common.MathB2.Mul(xfB.R, manifold.LocalPlaneNormal);
						Vec2 planePoint = Common.MathB2.Mul(xfB, manifold.LocalPoint);
						...
						for (int i = 0; i < manifold.PointCount; ++i)
						{
							Vec2 clipPoint = Common.MathB2.Mul(xfA, manifold.Points[i].LocalPoint);
