...
#warning "CAS"
	...
	public class BroadPhase
	{
...
#else
		public static readonly ushort BROADPHASE_MAX = Common.MathB2.USHRT_MAX;
#endif
		...
		{
			Vec2 d = Common.MathB2.Max(aabb.LowerBound - _worldAABB.UpperBound, _worldAABB.LowerBound - aabb.UpperBound);
			return Common.MathB2.Max(d.X, d.Y) < 0.0f;
		}
...
#warning "Check this"
			...
			for (int axis = 0; axis < 2; ++axis)
			{
				...
				if (deltaLower < 0)
				{
					...
					while (index > 0 && lowerValue < bounds[index - 1].Value)
					{
						...
						Common.MathB2.Swap<Bound>(ref bounds[index], ref bounds[index - 1]);
						--index;
					}
				}
		...
		private void ComputeBounds(out ushort[] lowerValues, out ushort[] upperValues, AABB aabb)
		{
			...
			Vec2 minVertex = Common.MathB2.Clamp(aabb.LowerBound, _worldAABB.LowerBound, _worldAABB.UpperBound);
			Vec2 maxVertex = Common.MathB2.Clamp(aabb.UpperBound, _worldAABB.LowerBound, _worldAABB.UpperBound);
