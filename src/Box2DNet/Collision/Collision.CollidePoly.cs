...
namespace Box2DNet.Collision
{
	public partial class Collision
	{
		...
		public static float EdgeSeparation(PolygonShape poly1, XForm xf1, int edge1, PolygonShape poly2, XForm xf2)
		{
			...
			Vec2 normal1World = Common.MathB2.Mul(xf1.R, normals1[edge1]);
			Vec2 normal1 = Common.MathB2.MulT(xf2.R, normal1World);
			...
			Vec2 v1 = Common.MathB2.Mul(xf1, vertices1[edge1]);
			Vec2 v2 = Common.MathB2.Mul(xf2, vertices2[index]);
		...
		public static float FindMaxSeparation(ref int edgeIndex, PolygonShape poly1, XForm xf1, PolygonShape poly2, XForm xf2)
		{
			...
			Vec2 d = Common.MathB2.Mul(xf2, poly2._centroid) - Common.MathB2.Mul(xf1, poly1._centroid);
			Vec2 dLocal1 = Common.MathB2.MulT(xf1.R, d);
