...
namespace Box2DNet.Collision
{
	...
	{
		public static readonly ushort NullPair = Common.MathB2.USHRT_MAX;
		public static readonly ushort NullProxy = Common.MathB2.USHRT_MAX;
		...
		public PairManager()
		{
			Box2DNetDebug.Assert(Common.MathB2.IsPowerOfTwo((uint)PairManager.TableCapacity) == true);
		...
		*/
		...
		private Pair Find(int proxyId1, int proxyId2)
		{
			if (proxyId1 > proxyId2)
				Common.MathB2.Swap<int>(ref proxyId1, ref proxyId2);
