...
namespace Box2DNet.Dynamics
{
	...
	public class GearJoint : Joint
	{
		...
		{
			// TODO_ERIN not tested
			Vec2 r = Common.MathB2.Mul(_body2.GetXForm().R, _localAnchor2 - _body2.GetLocalCenter());
			Vec2 P = _impulse * _J.Linear2;
		...
		internal override void InitVelocityConstraints(TimeStep step)
		{
			...
			{
				Vec2 ug = Common.MathB2.Mul(g1.GetXForm().R, _prismatic1._localXAxis1);
				Vec2 r = Common.MathB2.Mul(b1.GetXForm().R, _localAnchor1 - b1.GetLocalCenter());
			...
			{
				Vec2 ug = Common.MathB2.Mul(g2.GetXForm().R, _prismatic2._localXAxis1);
				Vec2 r = Common.MathB2.Mul(b2.GetXForm().R, _localAnchor2 - b2.GetLocalCenter());
				float crug = Vec2.Cross(r, ug);
