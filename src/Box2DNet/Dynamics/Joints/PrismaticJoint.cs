...
{
	using Box2DXMath = Box2DNet.Common.MathB2;
	...
	public class PrismaticJoint : Joint
	{
		...
		public float JointSpeed
		{
			get
			{
				...
				Vec2 r1 = Common.MathB2.Mul(b1.GetXForm().R, _localAnchor1 - b1.GetLocalCenter());
				Vec2 r2 = Common.MathB2.Mul(b2.GetXForm().R, _localAnchor2 - b2.GetLocalCenter());
		...
		internal override bool SolvePositionConstraints(float baumgarte)
		{
			...
			linearError = Box2DNet.Common.MathB2.Max(linearError, Box2DNet.Common.MathB2.Abs(C1.X));
			angularError = Box2DNet.Common.MathB2.Abs(C1.Y);
