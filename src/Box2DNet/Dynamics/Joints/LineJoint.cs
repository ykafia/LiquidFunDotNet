...
namespace Box2DNet.Dynamics
{
	...
	public class LineJoint : Joint
	{
		...
		public float GetJointSpeed()
		{
			...
			Vec2 r1 = Box2DNet.Common.MathB2.Mul(b1.GetXForm().R, _localAnchor1 - b1.GetLocalCenter());
			Vec2 r2 = Box2DNet.Common.MathB2.Mul(b2.GetXForm().R, _localAnchor2 - b2.GetLocalCenter());
		...
		internal override void InitVelocityConstraints(TimeStep step)
		{
			...
			Vec2 r1 = Box2DNet.Common.MathB2.Mul(xf1.R, _localAnchor1 - _localCenter1);
			Vec2 r2 = Box2DNet.Common.MathB2.Mul(xf2.R, _localAnchor2 - _localCenter2);
			...
			{
				_axis = Box2DNet.Common.MathB2.Mul(xf1.R, _localXAxis1);
			...
			{
				_perp = Box2DNet.Common.MathB2.Mul(xf1.R, _localYAxis1);
			...
			if (_enableLimit)
			{
				...
				if (Box2DNet.Common.MathB2.Abs(_upperTranslation - _lowerTranslation) < 2.0f * Settings.LinearSlop)
				{
		...
		internal override void SolveVelocityConstraints(TimeStep step)
		{
			...
			if (_enableLimit && _limitState != LimitState.InactiveLimit)
			{
				...
				if (_limitState == LimitState.AtLowerLimit)
				{
					_impulse.Y = Box2DNet.Common.MathB2.Max(_impulse.Y, 0.0f);
				}
				else if (_limitState == LimitState.AtUpperLimit)
				{
					_impulse.Y = Box2DNet.Common.MathB2.Min(_impulse.Y, 0.0f);
				}
		...
		internal override bool SolvePositionConstraints(float baumgarte)
		{
			...
			Vec2 r1 = Box2DNet.Common.MathB2.Mul(R1, _localAnchor1 - _localCenter1);
			Vec2 r2 = Box2DNet.Common.MathB2.Mul(R2, _localAnchor2 - _localCenter2);
			Vec2 d = c2 + r2 - c1 - r1;

			if (_enableLimit)
			{
				_axis = Box2DNet.Common.MathB2.Mul(R1, _localXAxis1);
				...
				if (Box2DNet.Common.MathB2.Abs(_upperTranslation - _lowerTranslation) < 2.0f * Settings.LinearSlop)
				{
					...
					C2 = Box2DNet.Common.MathB2.Clamp(translation, -Settings.MaxLinearCorrection, Settings.MaxLinearCorrection);
					linearError = Box2DNet.Common.MathB2.Abs(translation);
					active = true;
				}
				else if (translation <= _lowerTranslation)
				{
					// Prevent large linear corrections and allow some slop.
					C2 = Box2DNet.Common.MathB2.Clamp(translation - _lowerTranslation + Settings.LinearSlop, -Settings.MaxLinearCorrection, 0.0f);
				...
				{
					// Prevent large linear corrections and allow some slop.
					C2 = Box2DNet.Common.MathB2.Clamp(translation - _upperTranslation - Settings.LinearSlop, 0.0f, Settings.MaxLinearCorrection);
					linearError = translation - _upperTranslation;
					active = true;
				}
			}

			_perp = Box2DNet.Common.MathB2.Mul(R1, _localYAxis1);
			...
			linearError = Box2DNet.Common.MathB2.Max(linearError, Box2DNet.Common.MathB2.Abs(C1));
			angularError = 0.0f;
