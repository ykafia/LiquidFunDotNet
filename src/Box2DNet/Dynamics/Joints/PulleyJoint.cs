...
namespace Box2DNet.Dynamics
{
	...
	public class PulleyJoint : Joint
	{
			...
			: base(def)
		{
			...
			_maxLength1 = Common.MathB2.Min(def.MaxLength1, _constant - _ratio * PulleyJoint.MinPulleyLength);
			_maxLength2 = Common.MathB2.Min(def.MaxLength2, (_constant - PulleyJoint.MinPulleyLength) / _ratio);
		...
		internal override void SolveVelocityConstraints(TimeStep step)
		{
			...
			if (_state == LimitState.AtUpperLimit)
			{
				...
				_impulse = Box2DNet.Common.MathB2.Max(0.0f, _impulse + impulse);
			...
			if (_limitState1 == LimitState.AtUpperLimit)
			{
				...
				_limitImpulse1 = Box2DNet.Common.MathB2.Max(0.0f, _limitImpulse1 + impulse);
			...
			if (_limitState2 == LimitState.AtUpperLimit)
			{
				...
				_limitImpulse2 = Box2DNet.Common.MathB2.Max(0.0f, _limitImpulse2 + impulse);
