...
namespace Box2DNet.Dynamics
{
	...
	public class Body : IDisposable
	{
		...
		internal Body(BodyDef bd, World world)
		{
			...
			_sweep.C0 = _sweep.C = Common.MathB2.Mul(_xf, _sweep.LocalCenter);
		...
		internal bool SynchronizeFixtures()
		{
			XForm xf1 = new XForm();
			xf1.R.Set(_sweep.A0);
			xf1.Position = _sweep.C0 - Common.MathB2.Mul(xf1.R, _sweep.LocalCenter);
		...
		{
			return Common.MathB2.Mul(_xf, localPoint);
		}
		...
		{
			return Common.MathB2.Mul(_xf.R, localVector);
		}
		...
		{
			return Common.MathB2.MulT(_xf, worldPoint);
		}
		...
		{
			return Common.MathB2.MulT(_xf.R, worldVector);
		}
		...
		{
			_xf.R.Set(_sweep.A);
			_xf.Position = _sweep.C - Common.MathB2.Mul(_xf.R, _sweep.LocalCenter);
		}
