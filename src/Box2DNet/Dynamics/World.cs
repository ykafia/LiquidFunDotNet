				...
				for (Contact c = _contactList; c != null; c = c._next)
				{
					...
					else
					{
						...
						if (0.0f < toi && toi < 1.0f)
						{
							...
							toi = Box2DNet.Common.MathB2.Min((1.0f - toi) * t0 + toi, 1.0f);
						}
				...
				case ShapeType.CircleShape:
					{
						...
						Vec2 center = Box2DNet.Common.MathB2.Mul(xf, circle._position);
				...
				case ShapeType.PolygonShape:
					{
						...
						{
							vertices[i] = Box2DNet.Common.MathB2.Mul(xf, localVertices[i]);
						}
				...
				case ShapeType.EdgeShape:
					{
						...
						_debugDraw.DrawSegment(Box2DNet.Common.MathB2.Mul(xf, edge.Vertex1), Box2DNet.Common.MathB2.Mul(xf, edge.Vertex2), color);
					}
					break;
			}
		}
